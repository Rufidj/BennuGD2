...
BEGIN
    ...
    // golpe1=sound_load("sound/golpe1.wav"); // GUA EN TODA LA CARA (A�ADIR)
...
BEGIN
    ...
    if ( juegan_dos == 0 )
        ...
        if ( estado_fase == 7 )
            ...
            signal( type jose_player1, s_kill );
            jose_player1( 69, 383 );
            nombre_pantalla = "2.2 Infiltraci�n en la base";
            mapa_pantalla = 576;
        end
        if ( estado_fase == 8 )
            jose_player1( 320, 0 );
        ...
        if ( estado_fase == 22 )
            nave( 150, 320 );
            camara_nave();
            nombre_pantalla = "3.1 Vuelo en avi�n";
            mapa_pantalla = 0;
        end
        if ( estado_fase == 23 )
            camara_juego();
        ...
        if ( estado_fase == 24 )
            ...
            nombre_pantalla = "3.3 Monta�a peligrosa";
            mapa_pantalla = 650;
        end
        if ( estado_fase == 25 )
            camara_horizontal();
...
BEGIN
    ...
    LOOP
        ...
        if ( estado == 6 )
            ...
            if ( obj_nombre != "vac�o       " )
                obj_linea1 = "Objetos ocultos de colecci�n:";
            ...
            if ( posicion == 2 )
                ...
                if ( objetos_combustible > 0 )
                    ...
                    obj_linea1 = "Un recipiente con un l�quido negro?";
                    obj_linea2 = "parece salsa de esa del chino";
                    obj_linea3 = "pero sabe a combustible de avi�n";
                end
            end
            if ( posicion == 16 )
                x = 416;
